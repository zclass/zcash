 ...
 *
 * CBlock(hash=00040fe8, ver=4, hashPrevBlock=00000000000000, hashMerkleRoot=c4eaa5, nTime=1478403829, nBits=1f07ffff, nNonce=4695, vtx=1)
...
public:
    CMainParams() {
        ...
        consensus.vUpgrades[Consensus::UPGRADE_SAPLING].nActivationHeight = 500500;
...
public:
    CTestNetParams() {
        ...
        eh_epoch_1 = eh200_9;
        eh_epoch_2 = eh144_5;
        eh_epoch_1_endblock = 12010;
        eh_epoch_2_startblock = 12000;
